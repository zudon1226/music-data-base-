    ...
    <div style={appStyle}>
      ...
      >
        ...
        <div style={{ lineHeight: 2 }}>
          <div>🎵 Tracks: {songs.length}</div>
          <div>❤️ Likes: {totalLikes}</div>
      ...
      <div style={{ flex: 1, padding: "30px 30px 90px" }}>
        <div
          style={{
            background:
        ...
        >
          SPONSOR AD — V19 Creator Platform
        </div>

        <h1 style={{ fontSize: 64 }}>
          Music Business Platform V19
        </h1>
