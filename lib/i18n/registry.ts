...
export const SUPPORTED_LANGUAGES: SupportedLanguage[] = [
    ...
    { code: "de", englishName: "German", nativeName: "Deutsch", translationComplete: false, rtl: false },
    { code: "it", englishName: "Italian", nativeName: "Italiano", translationComplete: false, rtl: false },
    { code: "nl", englishName: "Dutch", nativeName: "Nederlands", translationComplete: false, rtl: false },
    { code: "ar", englishName: "Arabic", nativeName: "العربية", translationComplete: false, rtl: true },
    { code: "he", englishName: "Hebrew", nativeName: "עברית", translationComplete: false, rtl: true },
    { code: "tr", englishName: "Turkish", nativeName: "Türkçe", translationComplete: false, rtl: false },
    { code: "ru", englishName: "Russian", nativeName: "Русский", translationComplete: false, rtl: false },
    { code: "uk", englishName: "Ukrainian", nativeName: "Українська", translationComplete: false, rtl: false },
    { code: "pl", englishName: "Polish", nativeName: "Polski", translationComplete: false, rtl: false },
    { code: "ro", englishName: "Romanian", nativeName: "Română", translationComplete: false, rtl: false },
    { code: "el", englishName: "Greek", nativeName: "Ελληνικά", translationComplete: false, rtl: false },
