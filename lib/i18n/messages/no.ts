...
export const noMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            title: "Sponsing",
            pageSubtitle: "Søk om fremhevede plasseringer og følg sponsorkampanjen din på Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Velg hvordan du planlegger å bruke Music Data Base. Skaperkontoer kan fortsatt lytte, lagre, kjøpe og bygge spillelister.",
        accountTypeListener: "Lytter",
        accountTypeArtist: "Musikkartist",
        accountTypeProducer: "Produsent",
        accountTypeArtistProducer: "Musikkartist og produsent",
            redeemInvite: "Løs inn invitasjon",
            redeemInviteHelp: "Skriv inn grunnlegger-invitasjonskoden din for å knytte den til denne påloggede kontoen.",
            redeemInviteSuccess: "Invitasjon løst inn. Grunnlegger-søknaden din venter på godkjenning fra eieren.",
            redeemInviteSuccessApproved: "Invitasjon løst inn. Velkommen til Music Data Base.",
            email: "E-post",
    ...
    notifications: {
            ...
            pageSubtitle: "Varsler om kjøp, opplastinger, følgere og plattformaktivitet."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadBeat: "Last opp beat",
            uploadInstrumental: "Last opp instrumental",
            uploadProducerVideo: "Last opp video",
            uploadProducerAlbum: "Last opp album",
            artistStudio: "Artiststudio",
            producerStudio: "Produsentstudio",
            podcastStudio: "Podkaststudio",
            artistStudioSubtitle: "Last opp sanger, album og videoer med metadata for artistutgivelse.",
            producerStudioSubtitle: "Last opp sanger, beats, instrumentals, album og videoer med produksjonsmetadata.",
            studioKicker: "Opplasting for skaper",
            switchStudio: "Bytt studio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Ringetoner du har kjøpt. Spill av, last ned, favorittmerk og se lisensdetaljer.",
            favoritesSubtitle: "Ringetoner du har lagret som favoritter.",
            browseMarketplace: "Utforsk ringetonmarkedet",
            play: "Spill av",
