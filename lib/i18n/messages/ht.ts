...
export const htMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            title: "Patwonaj",
            pageSubtitle: "Aplike pou plasman an vedèt epi swiv kanpay patwonaj ou sou Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Chwazi kijan w ap itilize Music Data Base. Kont kreyatè yo toujou ka koute, sove, achte epi bati playlist.",
        accountTypeListener: "Oditè",
        accountTypeArtist: "Atis",
        accountTypeProducer: "Pwodiktè",
        accountTypeArtistProducer: "Atis ak pwodiktè",
            redeemInvite: "Echanje envitasyon",
            redeemInviteHelp: "Antre kòd envitasyon fondatè ou pou l attaché ak kont sa a kote w konekte.",
            redeemInviteSuccess: "Envitasyon an echanje. Aplikasyon fondatè ou ap tann apwobasyon pwopriyetè a.",
            redeemInviteSuccessApproved: "Envitasyon an echanje. Byenveni nan Music Data Base.",
            email: "Imèl",
    ...
    notifications: {
            ...
            pageSubtitle: "Alèt pou acha, telechajman, swiv, ak aktivite sou platfòm nan."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadBeat: "Telechaje yon beat",
            uploadInstrumental: "Telechaje yon enstrimantal",
            uploadProducerVideo: "Telechaje yon videyo",
            uploadProducerAlbum: "Telechaje yon album",
            artistStudio: "Studio atis",
            producerStudio: "Studio pwodiktè",
            podcastStudio: "Studio podcast",
            artistStudioSubtitle: "Telechaje chante, album ak videyo ak metadata lage atis.",
            producerStudioSubtitle: "Telechaje chante, beat, enstrimantal, album ak videyo ak metadata pwodiksyon.",
            studioKicker: "Telechajman kreyatè",
            switchStudio: "Chanje studio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Bèl son ou te achte. Jwe, telechaje, mete nan favori epi revize detay lisans yo.",
            favoritesSubtitle: "Bèl son ou te sove kòm favori.",
            browseMarketplace: "Gade mache bèl son yo",
            play: "Jwe",
