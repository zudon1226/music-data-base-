...
export const esMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            title: "Patrocinio",
            pageSubtitle: "Solicita ubicaciones destacadas y haz seguimiento de tu campaña de patrocinio en Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Elige cómo planeas usar Music Data Base. Las cuentas de creador también pueden escuchar, guardar, comprar y crear listas de reproducción.",
        accountTypeListener: "Oyente",
        accountTypeArtist: "Artista",
        accountTypeProducer: "Productor",
        accountTypeArtistProducer: "Artista y productor",
            redeemInvite: "Canjear invitación",
            redeemInviteHelp: "Introduce tu código de invitación fundadora para vincularlo a esta cuenta con sesión iniciada.",
            redeemInviteSuccess: "Invitación canjeada. Tu solicitud fundadora está pendiente de aprobación del propietario.",
            redeemInviteSuccessApproved: "Invitación canjeada. Bienvenido a Music Data Base.",
    ...
    notifications: {
            ...
            pageSubtitle: "Alertas de compras, subidas, seguidores y actividad de la plataforma."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadInstrumental: "Subir instrumental",
            uploadProducerVideo: "Subir vídeo",
            uploadProducerAlbum: "Subir álbum",
            artistStudio: "Estudio de artista",
            producerStudio: "Estudio de productor",
            podcastStudio: "Estudio de podcast",
            artistStudioSubtitle: "Sube canciones, álbumes y vídeos con metadatos de lanzamiento de artista.",
            producerStudioSubtitle: "Sube canciones, beats, instrumentales, álbumes y vídeos con metadatos de producción.",
            studioKicker: "Subida de creador",
            switchStudio: "Cambiar estudio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Tonos que compraste. Reproduce, descarga, marca como favorito y revisa los detalles de la licencia.",
            favoritesSubtitle: "Tonos que guardaste como favoritos.",
            browseMarketplace: "Explorar mercado de tonos",
            play: "Reproducir",
