...
export const itMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            ...
            pageSubtitle: "Richiedi posizionamenti in evidenza e monitora la tua campagna di sponsorship su Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Scegli come intendi usare Music Data Base. Gli account creator possono comunque ascoltare, salvare, acquistare e creare playlist.",
        accountTypeListener: "Ascoltatore",
        accountTypeArtist: "Artista",
        accountTypeProducer: "Produttore",
        accountTypeArtistProducer: "Artista e produttore",
            redeemInvite: "Riscatta invito",
            redeemInviteHelp: "Inserisci il codice invito fondatore per associarlo a questo account con accesso effettuato.",
            redeemInviteSuccess: "Invito riscattato. La tua candidatura fondatore è in attesa di approvazione del proprietario.",
            redeemInviteSuccessApproved: "Invito riscattato. Benvenuto in Music Data Base.",
    ...
    notifications: {
            ...
            pageSubtitle: "Avvisi su acquisti, caricamenti, follow e attività della piattaforma."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadInstrumental: "Carica strumentale",
            uploadProducerVideo: "Carica video",
            uploadProducerAlbum: "Carica album",
            artistStudio: "Studio artista",
            producerStudio: "Studio produttore",
            podcastStudio: "Studio podcast",
            artistStudioSubtitle: "Carica brani, album e video con metadati di uscita artista.",
            producerStudioSubtitle: "Carica brani, beat, strumentali, album e video con metadati di produzione.",
            studioKicker: "Caricamento creator",
            switchStudio: "Cambia studio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Suonerie acquistate. Riproduci, scarica, aggiungi ai preferiti e consulta i dettagli della licenza.",
            favoritesSubtitle: "Suonerie salvate come preferite.",
            browseMarketplace: "Sfoglia marketplace suonerie",
            play: "Riproduci",
