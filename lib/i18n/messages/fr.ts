...
export const frMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            title: "Parrainage",
            pageSubtitle: "Demandez des emplacements en vedette et suivez votre campagne de sponsoring sur Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Choisissez comment vous comptez utiliser Music Data Base. Les comptes créateur peuvent aussi écouter, enregistrer, acheter et créer des playlists.",
        accountTypeListener: "Auditeur",
        accountTypeArtist: "Artiste",
        accountTypeProducer: "Producteur",
        accountTypeArtistProducer: "Artiste et producteur",
            redeemInvite: "Utiliser une invitation",
            redeemInviteHelp: "Saisissez votre code d'invitation fondatrice pour l'associer à ce compte connecté.",
            redeemInviteSuccess: "Invitation utilisée. Votre candidature fondatrice est en attente d'approbation du propriétaire.",
            redeemInviteSuccessApproved: "Invitation utilisée. Bienvenue sur Music Data Base.",
            email: "E-mail",
    ...
    notifications: {
            ...
            pageSubtitle: "Alertes pour les achats, les mises en ligne, les abonnements et l'activité de la plateforme."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadBeat: "Mettre en ligne un beat",
            uploadInstrumental: "Mettre en ligne un instrumental",
            uploadProducerVideo: "Mettre en ligne une vidéo",
            uploadProducerAlbum: "Mettre en ligne un album",
            artistStudio: "Studio artiste",
            producerStudio: "Studio producteur",
            podcastStudio: "Studio podcast",
            artistStudioSubtitle: "Mettez en ligne des chansons, albums et vidéos avec les métadonnées de sortie artiste.",
            producerStudioSubtitle: "Mettez en ligne des chansons, beats, instrumentaux, albums et vidéos avec les métadonnées de production.",
            studioKicker: "Mise en ligne créateur",
            switchStudio: "Changer de studio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Sonneries que vous avez achetées. Écoutez, téléchargez, ajoutez aux favoris et consultez les détails de licence.",
            favoritesSubtitle: "Sonneries que vous avez enregistrées comme favorites.",
            browseMarketplace: "Parcourir la marketplace de sonneries",
            play: "Lire",
