...
export const ptMessages: LocaleMessageDictionary = {
    ...
    sponsor: {
            title: "Patrocínio",
            pageSubtitle: "Candidate-se a destaques e acompanhe sua campanha de patrocínio no Music Data Base.",
        },
    auth: {
        ...
        accountTypeHelp: "Escolha como pretende usar o Music Data Base. Contas de criador ainda podem ouvir, guardar, comprar e criar playlists.",
        accountTypeListener: "Ouvinte",
        accountTypeArtist: "Artista",
        accountTypeProducer: "Produtor",
        accountTypeArtistProducer: "Artista e produtor",
            redeemInvite: "Resgatar convite",
            redeemInviteHelp: "Introduza o seu código de convite fundador para o associar a esta conta com sessão iniciada.",
            redeemInviteSuccess: "Convite resgatado. A sua candidatura fundadora aguarda aprovação do proprietário.",
            redeemInviteSuccessApproved: "Convite resgatado. Bem-vindo ao Music Data Base.",
            email: "E-mail",
    ...
    notifications: {
            ...
            pageSubtitle: "Alertas de compras, envios, seguidores e atividade da plataforma."
        },
    dashboard: {
            profile: {
    ...
    upload: {
            ...
            uploadInstrumental: "Enviar instrumental",
            uploadProducerVideo: "Enviar vídeo",
            uploadProducerAlbum: "Enviar álbum",
            artistStudio: "Estúdio de artista",
            producerStudio: "Estúdio de produtor",
            podcastStudio: "Estúdio de podcast",
            artistStudioSubtitle: "Envie músicas, álbuns e vídeos com metadados de lançamento de artista.",
            producerStudioSubtitle: "Envie músicas, beats, instrumentais, álbuns e vídeos com metadados de produção.",
            studioKicker: "Envio de criador",
            switchStudio: "Mudar estúdio",
    ...
    ringtones: {
        ...
        personalBadge: "Personal",
            ...
            purchasedSubtitle: "Toques que você comprou. Reproduza, baixe, favorite e revise os detalhes da licença.",
            favoritesSubtitle: "Toques que você salvou como favoritos.",
            browseMarketplace: "Explorar marketplace de toques",
            play: "Reproduzir",
