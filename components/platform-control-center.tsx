            ...
            <section className="stability-panel control-center-panel">
                ...
                <div className={`control-overview-grid control-layout--${controlViewMode}`} data-control-view={controlViewMode}>
                    {[
                        ...
                        ["Total Podcast Shows", overview?.totalPodcastShows],
                        ["Total Podcast Episodes", overview?.totalPodcastEpisodes],
                        ["Audio Podcast Episodes", overview?.totalPodcastAudioEpisodes],
                        ["Video Podcast Episodes", overview?.totalPodcastVideoEpisodes],
                        ...
                        ["Total Podcast Audio Plays", overview?.totalPodcastAudioPlays],
                        ["Total Podcast Video Views", overview?.totalPodcastVideoViews],
